...
function HasilPanduanContent() {
          ...
          <div className="flex items-center justify-between mb-6 p-4 bg-blue-50 dark:bg-blue-900/20 rounded-xl">
            <div className="flex items-center gap-3 flex-1">
              ...
              <div className="flex-1">
                ...
                <p className="text-sm text-gray-600 dark:text-gray-300 ml-6">{tripInfo.departure_location}</p>
                
                <div className="flex items-center gap-2 mt-3">
                  <MapPin className="w-4 h-4 text-red-600" />
                  <span className="font-semibold text-gray-900 dark:text-white">Tujuan</span>
                </div>
                <p className="text-sm text-gray-600 dark:text-gray-300 ml-6">{tripInfo.destination_location}</p>
              </div>
            </div>
          </div>
  ...
  // Custom icons for trip purposes
      ...
      <div className="min-h-screen bg-gradient-to-b from-blue-50 to-white dark:from-gray-900 dark:to-gray-800 px-4 py-16">
        <div className="max-w-6xl mx-auto text-center">
          <div className="flex flex-col items-center justify-center gap-4 py-20">
            ...
            <p className="text-lg text-blue-800 dark:text-blue-200">Memuat persiapan berlayar...</p>
          </div>
        </div>
      </div>
    );
      ...
      <div className="min-h-screen bg-gradient-to-b from-blue-50 to-white dark:from-gray-900 dark:to-gray-800 px-4 py-16">
        <div className="max-w-6xl mx-auto space-y-6">
          ...
          <button
            ...
            className="bg-blue-600 hover:bg-blue-700 dark:bg-blue-700 dark:hover:bg-blue-800 text-white px-6 py-2 rounded-lg transition-colors shadow-sm"
          >
            Kembali ke Form
          </button>
        </div>
                      ...
                      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
                        ...
                        <button 
                          ...
                          className={`px-5 py-2.5 rounded-lg flex items-center gap-2 text-sm font-medium transition-all duration-200 min-w-[140px] justify-center ${
                            item.is_completed 
                              ? "bg-green-100 hover:bg-green-200 dark:bg-green-900 dark:hover:bg-green-800 text-green-800 dark:text-green-200 shadow-sm" 
