      ...
      <div className="w-full md:w-1/2 flex items-center justify-center px-6 py-12 md:px-12 lg:px-24 bg-white">
        <div className="w-full max-w-md">
          ...
          <div className="text-center mb-10">
            ...
            <h2 className="text-2xl font-semibold text-[#053040] mb-2">Masuk ke Akun Anda</h2>
      ...
      <div className="hidden md:block w-1/2 bg-gradient-to-br from-[#053040] to-[#2C5B6B] relative">
        <div className="absolute inset-0 flex items-center justify-center p-12">
          <div className="text-center text-white max-w-lg">
            ...
            <h3 className="text-3xl font-bold mb-4">Selamat Datang Kembali</h3>
            <p className="text-white text-opacity-90 text-lg leading-relaxed">
              Platform komunitas pelaut terpercaya untuk berbagi informasi kondisi laut 
              dan keselamatan pelayaran. Mari bersama-sama menjaga keselamatan di laut.
            </p>
            <div className="mt-8 flex justify-center space-x-4">
              <div className="text-center">
                <div className="text-2xl font-bold">500+</div>
                <div className="text-white text-opacity-80">Pelaut Aktif</div>
              </div>
              <div className="text-center">
                <div className="text-2xl font-bold">1000+</div>
                <div className="text-white text-opacity-80">Laporan Terverifikasi</div>
              </div>
              <div className="text-center">
                <div className="text-2xl font-bold">50+</div>
                <div className="text-white text-opacity-80">Komunitas</div>
              </div>
            </div>
          </div>
        </div>
